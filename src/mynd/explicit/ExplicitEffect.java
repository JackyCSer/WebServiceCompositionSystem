 ...
 * are normalized, i.e., there are no nested conditions. // TODO helper class
 * bla
 * 
...
public class ExplicitEffect
{
	...
	/**
	 * Checks whether this effect is enabled in a given variable assignment,
	 * i.e., if its condition is satisfied.
	 * 
	...
	public boolean equals(Object obj)
	{
		...
		return other.variable == variable && other.value == value
	...
	public String toString()
	{
		...
		String string = Global.problem.propositionNames.get(variable).get(value);
		
		buffer.append(variable + ":" + value + ", name: " + string +")");
